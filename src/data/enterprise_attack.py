...
from common.paths import (
    PROJECT_ROOT, DATA_ROOT, ATTACK_STIX_DIR, ENTERPRISE_DIR, PROCESSED_DIR,
)
...
OUT_CSV      = PROCESSED_DIR / "ti_groups_techniques.csv"
...
def _find_bundle() -> pathlib.Path:
    ...
    raise FileNotFoundError(
        ...
        f"or fallback: {ATTACK_DIR / 'enterprise-attack.json'}\n"
